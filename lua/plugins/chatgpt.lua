...
return function(config)
    if type(config.plugins.chatgpt) == 'boolean' and not config.plugins.chatgpt then
        return {}
    end
    ...
    return {
        ...
        config = function()
            if config.plugins.chatgpt and type(config.plugins.chatgpt) == 'function' then
            ...
            function _G.ChatGPTSubmit(model, mode)
                ...
                local system_role = user_input ~= '' and user_input or ({
                    ...
                    improver  = improver_role,
                    explainer = explainer_role,
            ...
            vim.api.nvim_set_keymap('v', '<leader>cr', ':lua ChatGPTSubmit("gpt-3.5-turbo", "reviewer")<CR>',
                { noremap = true, silent = true })
            vim.api.nvim_set_keymap('v', '<leader>ci', ':lua ChatGPTSubmit("gpt-3.5-turbo", "improver")<CR>',
                { noremap = true, silent = true })
            vim.api.nvim_set_keymap('v', '<leader>ce', ':lua ChatGPTSubmit("gpt-3.5-turbo", "explainer")<CR>',
                { noremap = true, silent = true })
            vim.api.nvim_set_keymap('v', '<leader>cg', ':lua ChatGPTSubmit("gpt-3.5-turbo", "generator")<CR>',
                { noremap = true, silent = true })
            vim.api.nvim_set_keymap('v', '<leader>cc', ':lua ChatGPTSubmit("gpt-3.5-turbo", "")<CR>',
                { noremap = true, silent = true })
            vim.api.nvim_set_keymap('v', '<leader>cp', ':lua ChatGPTPrompt()<CR>', { noremap = true, silent = true })

            vim.api.nvim_set_keymap('v', '<leader>c4r', ':lua ChatGPTSubmit("gpt-4", "reviewer")<CR>',
                { noremap = true, silent = true })
            vim.api.nvim_set_keymap('v', '<leader>c4i', ':lua ChatGPTSubmit("gpt-4", "improver")<CR>',
                { noremap = true, silent = true })
            vim.api.nvim_set_keymap('v', '<leader>c4e', ':lua ChatGPTSubmit("gpt-4", "explainer")<CR>',
                { noremap = true, silent = true })
            vim.api.nvim_set_keymap('v', '<leader>c4g', ':lua ChatGPTSubmit("gpt-4", "generator")<CR>',
                { noremap = true, silent = true })
            vim.api.nvim_set_keymap('v', '<leader>c4c', ':lua ChatGPTSubmit("gpt-4", "")<CR>',
                { noremap = true, silent = true })
        end
    }
end
